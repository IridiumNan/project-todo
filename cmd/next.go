...
var nextCmd = &cobra.Command{
	Use:   "next",
	Short: "Pop a work on todo list with specific energy level",
	Long: `Next command will load metadata from file with your energy level.
	Use flag --energy or -e for energy assign, if no flag, it will be energy low`,
	Run: execNext,
}
